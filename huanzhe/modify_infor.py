...
class runtime():
    ...
    def run(window, usr_name):
        ...
        canvas.create_text(100, 55, text='患者', font=("Arial", 24), fill='#e8f0eb')
        ...
        bt2 = Button(canvas_down, text='查看医生消息',fg='#424242',bg='#e6ece9', command=showresult,
             font=("Arial", 16))
        ...
        bt2 = Button(canvas_down, text='查看私人医生消息',fg='#424242',bg='#e6ece9', command=showprivatdoctorresult,
             font=("Arial", 16))
        ...
        def write_syptom():
            ...
            t=Label(frm_3,width=8,height=1,fg='#424242',text='症状：',font=('Arial',15))
            t.pack(side=LEFT)
...
# t1.pack()           
            ...
            t2 = Button(frm_3,text = '添加症状',fg='#424242',bg='#e6ece9',command = addline)
            t2.pack(side=RIGHT)

            frm_3.pack(side=TOP,fill=BOTH)

            frm_4=Frame(frame.frm_2)
            t=Label(frm_4,width=8,height=1,fg='#424242',text='症状图片：',font=('Arial',15))
            t.pack(side=LEFT)

            def uploadpic():
                print("上传图片")
                frm_add=Frame(frm_4)
                t5=Text(frm_4,height=1,fg='#424242',font=('Arial',15))
                t5.tag_config('t2',foreground='black',underline=True)
                t5.insert(1.0,'无','t2')
                t5.pack(side=LEFT)
            t6 = Button(frm_4,text = '上传图片',fg='#424242',bg='#e6ece9',command = uploadpic)
            t6.pack(side=RIGHT)
            ...
            fenlei=('不确定','骨科','神经外科','胸外科','心血管外科',
                ...
                '皮肤科','疼痛科','妇产科','儿科学')
            t=Label(frm_5,width=8,height=1,fg='#424242',text='选择科室',font=('Arial',15))
            t.pack(side=LEFT)
            ...
            t6 = Button(frm_6,text = '提交',fg='#424242',bg='#e6ece9',command = upload)
            t6.pack(side=TOP)
        ...
        bt3 = Button(canvas_down, text='填写症状给普通医生',fg='#424242',bg='#e6ece9', command=write_syptom,
                 font=("Arial", 16))
        ...
        def write_syptom_to_private():
            ...
            t=Label(frm_7,width=8,height=1,fg='#424242',text='症状：',font=('Arial',15))
            t.pack(side=LEFT)
...
# t1.pack()
            ...
            def addline():
                symptom_desc.t3.pack()
                symptom_desc.frm_add.pack()
            t2 = Button(frm_7,text = '添加症状',fg='#424242',bg='#e6ece9',command = addline)
            t2.pack(side=RIGHT)

            frm_7.pack(side=TOP,fill=BOTH)

            frm_8=Frame(frame.frm_1)
            t=Label(frm_8,width=8,height=1,fg='#424242',text='症状图片：',font=('Arial',15))
            t.pack(side=LEFT)

            def uploadpic():
                print("上传图片")
                frm_add=Frame(frm_8)
                t5=Text(frm_8,height=1,fg='#424242',font=('Arial',15))
                t5.tag_config('t2',foreground='black',underline=True)
                t5.insert(1.0,'无','t2')
                t5.pack(side=LEFT)
            t6 = Button(frm_8,text = '上传图片',fg='#424242',bg='#e6ece9',command = uploadpic)
            t6.pack(side=RIGHT)
...
#             frm_10.pack(side=TOP,fill=BOTH)
            ...
            def upload():
                ...
                print("提交成功")
            t6 = Button(frm_11,text = '提交',fg='#424242',bg='#e6ece9',command = uploadpic)
            t6.pack(side=TOP)
        ...
        bt3 = Button(canvas_down, text='填写症状给私人医生',fg='#424242',bg='#e6ece9', command=write_syptom_to_private,
                 font=("Arial", 16))
        ...
        #      command=printWindow, font=("Arial", 16))
...
##########################################################################
        ...
        bt5 = Button(canvas_down, text='修改个人信息',fg='#424242',bg='#e6ece9', command=show_mordify,
                 font=("Arial", 16))
        ...
        m_count_label = tk.Label(frame.canvas_modify,fg='#424242', text="你的账户是" + usr_name[0:-1], font=("Arial", 16))
        ...
        for i in range(3):
            if(i == 0):
                Radiobutton(frame.canvas_modify, variable=m_type,fg='#424242', text='患者', value=usr_type[0],
                    font=("Arial", 16), state=DISABLED).place(x=500, y=80)
            elif(i == 1):
                Radiobutton(frame.canvas_modify, variable=m_type,fg='#424242', text='医生', value=usr_type[1],
                    font=("Arial", 16), state=DISABLED).place(x=600, y=80)
            elif(i == 2):
                Radiobutton(frame.canvas_modify, variable=m_type,fg='#424242', text='私人医生', value=usr_type[2],
                    font=("Arial", 16), state=DISABLED).place(x=700, y=80)


        m_sex_label = tk.Label(frame.canvas_modify,fg='#424242', text='你的性别', font=("Arial", 16))
        ...
        for i in range(2):
            if(i == 0):
                Radiobutton(frame.canvas_modify, variable=m_sex,fg='#424242', text='男', value=show_gender[0],
                    command = lambda: man(), font=("Arial", 16), state=DISABLED).place(x=650, y=130)
            elif(i == 1):
                Radiobutton(frame.canvas_modify, variable=m_sex,fg='#424242', text='女', value=show_gender[1],
                    command = lambda: woman(), font=("Arial", 16), state=DISABLED).place(x=750, y=130)


        m_count_label.place(x=40, y=30)
        m_name_label = tk.Label(frame.canvas_modify,fg='#424242', text='昵称', font=("Arial", 16))
        ...
        m_age = StringVar()
        m_age.set(usr_age)
        m_age_label = tk.Label(frame.canvas_modify,fg='#424242', text="年龄", font=("Arial", 16))
        ...
        tk.Label(frame.canvas_patient,fg='#424242', text='--------------------------------------' +
         '-----------------------------------------------------------------' +
         '--------------------------------',
         font=("Arial", 16)).place(y=0)


        m_allergic_label = tk.Label(frame.canvas_patient,fg='#424242', text='过敏史', font=("Arial", 16))
        ...
        m_disease_label = tk.Label(frame.canvas_patient,fg='#424242', text='疾病史', font=("Arial", 16))
        ...
        m_medicine_label = tk.Label(frame.canvas_patient,fg='#424242', text='用药史', font=("Arial", 16))
        ...
        m_symptom_label = tk.Label(frame.canvas_patient,fg='#424242', text='症状描述', font=("Arial", 16))    
        ...
        m_famdis_label = tk.Label(frame.canvas_patient,fg='#424242', text='家庭病史', font=("Arial", 16))
        m_famdis_label.place(x=430, y=190)
        m_famdis_text = tk.Text(
            frame.canvas_patient,fg='#424242',font=("Arial", 16))
        ...
        tk.Label(frame.canvas_doctor,fg='#424242', text='--------------------------------------' +
         '-----------------------------------------------------------------' +
         '--------------------------------',
         font=("Arial", 16)).place(y=0)
        m_workspan_label = tk.Label(frame.canvas_doctor,fg='#424242', text="医龄", font=("Arial", 16))
        ...
        m_hospital_label = tk.Label(frame.canvas_doctor,fg='#424242', text="医院", font=("Arial", 16))
        ...
        m_workplace_label = tk.Label(frame.canvas_doctor,fg='#424242', text="科室", font=("Arial", 16))
        ...
        m_description_label = tk.Label(frame.canvas_doctor,fg='#424242', text="主要描述", font=("Arial", 16))
        m_description_label.place(x=40, y=190)
        m_description_text = tk.Text(frame.canvas_doctor,fg='#424242', font=("Arial", 16),width=29,height=10)
        ...
        def change_password():
            ...
            tk.Label(change_top,fg='#424242', text="请输入修改后的密码：", font=("楷体", 12)).place(x=40, y=30)
            tk.Label(change_top,fg='#424242', text="请再次确认您的密码：",
            ...
            btn_confirm = tk.Button(change_top,text="确定",fg='#424242',bg='#e6ece9', command = lambda:change_confirm(), font=("宋体", 12))
            btn_confirm.place(x=40,y=110)
            def change_cancel():
                change_top.destroy()
            btn_cancel = tk.Button(change_top,text="取消",fg='#424242',bg='#e6ece9', command = lambda:change_cancel(), font=("宋体", 12))
            btn_cancel.place(x=120,y=110)


        btn_modify_basic_information = Button(
            frame.canvas_modify, text='修改密码',fg='#424242',bg='#e6ece9', font=("Arial", 16), 
        ...
        btn_modify_OK = Button(
            frame.canvas_modify, text='确认修改',fg='#424242',bg='#e6ece9', font=("Arial", 16), 
